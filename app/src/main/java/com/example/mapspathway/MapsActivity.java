package com.example.mapspathway;
...
import com.example.mapspathway.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String getRequestUrl(LatLng origin, LatLng dest) {
        ...
        String parameter = str_org +"&" + str_dest +"&" +sensor +"&" +mode;

        // Output format
        String output = "json";

        // Create url to request
        String url = "https://maps.googleapis.com/maps/api/direction/" + output +"?" +parameter;
        return url;
    }
    ...
    public class TaskParser extends AsyncTask<String, Void, List<List<HashMap<String,String>>> >{
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> lists) {
            ...
            for (List<HashMap<String, String>> path : lists){
                ...
                for (HashMap<String, String> points : path){
